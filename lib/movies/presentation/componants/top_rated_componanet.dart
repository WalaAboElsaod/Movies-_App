...
import '../../../core/comp/dummy.dart';

class TopRatedComponanet extends StatelessWidget {
  const TopRatedComponanet({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    {
print('BlocBuilder  TopRatedComponanet');
