...
import 'package:movies/core/comp/ddd.dart';
...
class MovieDetailScreen extends StatelessWidget {
  ...
  return  BlocProvider(
      ...
      sl<MovieDetailsBloc>()..add(GetMoviesDetailsEvent(id))..add(GetMoviesRecommendationEvent(id))
  ,  lazy: false,
